...
function removeSpecialCharacters(str) {
    ...
    for (var i = 0; i < special_characters_map.length; i++)
...
function fixFloatPoint(value) {
    return Number(value.toFixed(2));
}
exports.fixFloatPoint = fixFloatPoint;
...
function reverseBirthday(bday) {
    return bday.substring(6, 10) + '/' + bday.substring(3, 5) + '/' + bday.substring(0, 2);
}
exports.reverseBirthday = reverseBirthday;
function isBirthdayReversed(bday) {
    if (bday.substring(2, 3) == '/' || bday.substring(2, 3) == '-')
        return false;
    else
        return true;
}
exports.isBirthdayReversed = isBirthdayReversed;
function unreverseBirthday(bday) {
    return bday.substring(8, 10) + '/' + bday.substring(5, 7) + '/' + bday.substring(0, 4);
}
exports.unreverseBirthday = unreverseBirthday;
var imagePath = {
